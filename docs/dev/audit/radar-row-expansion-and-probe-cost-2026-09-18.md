...
> **本文件的帧延迟表与"1 分钟约 12 秒"已撤回。** rotor 的 2.57× 实际是 1.22×，
> 双散射点的 2.01× 实际是 1.26×；一分钟数据实测 16.7 秒（房间内）／29.5 秒（走远）。
> 更正见 [验收与撤回](radar-perf-acceptance-and-retraction-2026-09-18.md)。
