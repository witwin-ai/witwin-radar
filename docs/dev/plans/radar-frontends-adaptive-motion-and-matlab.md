...
MATLAB execution is blocked: the installed R2025b Update 4 did not complete batch startup; the final actual comparison launch timed out after 120 seconds without outputs. Input export ran successfully; the MATLAB script and bounded launcher are delivered, but MATLAB numerical equivalence and performance are unverified. See docs/dev/audit/radar-frontends-adaptive-motion-acceptance-2026-09-16.md.
