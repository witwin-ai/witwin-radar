...
device or waveform declaration. ``test_rcs_sigma_ad.py`` owns that cell,
...
from witwin.radar.frontend import Adc, Agc, FrontendSpec, Noise
from witwin.radar.policy import require_host_float, require_host_floats
from witwin.radar.synthesis.assembly import FmcwSpec, OfdmSpec, PulsedSpec
...
# --------------------------------------------------------------------------
# The premise: every base kwarg set actually constructs
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
# Every field refuses a marked tensor, and names itself
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
# The refusal is a REFUSAL: it happens before anything else
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
# The boundary against the one supported configuration leaf
# --------------------------------------------------------------------------
