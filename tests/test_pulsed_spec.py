...
from witwin.radar.processing.range_doppler import lag_axis, matched_filter, pulse_samples
from witwin.radar.synthesis.assembly import PulsedSpec, SlowTimeMode, SynthesisPathBatch, require_pulsed_compatible
...
# --------------------------------------------------------------------------
# The compatibility guards, on CONFIGURED values only
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
# (first half)  the unit-energy replica
# --------------------------------------------------------------------------
