...
This module is the AD counterpart of :mod:`witwin.radar.host_parameters`, and it
sits beside it at the package root for the same reason: the rules are
cross-domain. ``processing`` and ``frontend`` both need the wall;
...
__all__ = ["first_order_only", "refuse_derivative"]
